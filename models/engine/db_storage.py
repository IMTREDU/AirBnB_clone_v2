...
class DBStorage:
    ...
    Attributes:
        __engine (sqlalchemy.Engine): The SQLAlchemy engine in use.
    ...
    def all(self, cls=None):
        """Queries all objects of a given class from the current session.

        If cls is None, queries all types of objects.

        Returns:
            A dictionary in the format <class name>.<obj id> = obj.
        """
        if cls is None:
