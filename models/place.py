...
class Place(BaseModel, Base):
    ...
    Attributes:
        ...
        city_id (sqlalchemy String): The ID of the place's city.
        user_id (sqlalchemy String): The ID of the place's user.
        ...
        reviews (sqlalchemy relationship): The relationship between place and reviews.
        amenities (sqlalchemy relationship): The relationship between place and amenities.
        amenity_ids (list): A list of IDs of all linked amenities.
    """
