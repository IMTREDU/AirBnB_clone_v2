...
def number_template(n):
    """
    Route for the /number_template/<n> URL that returns an HTML page only if n is an integer.
...
def number_odd_or_even(n):
    """
    Route for the /number_odd_or_even/<n> URL that returns an HTML page only if n is an integer.
    The HTML page displays "Number: n is even|odd" inside an H1 tag.
    """
